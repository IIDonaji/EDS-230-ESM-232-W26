...
what is the output of that model?

-   number of species

-   number of species per sq dollar
...
-   Are there inputs/parameters that you want to vary across cenarios (things you'd want to 'change')
    ...
    -   some things may have limitations that can impact this.
...
can effect the following; makes a differences when implanting it
